...
} else lns<-'No enough outliers for clustering analysis'
```
...
```
The following numbers of DEGs were selected from each outlier. Click on numbers to view full lists:

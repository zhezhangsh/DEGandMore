...
path.inputs<-"/nas/is1/zhangz/projects/curran/2015-09_human_medullo_RNAseq/r/pairwise/HH_neg-vs-HH_pos.rds";
```
...
An example of input data can be download from [here](https://github.com/zhezhangsh/DEGandMore/blob/master/examples/DeReport_Inputs.rds?raw=true)

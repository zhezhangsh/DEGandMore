...
if (nrow(kegg.stat) == 0) kegg.ind<-kegg.stat else {
  ...
  #   file.rename(fn, paste(path.kegg, fn, sep='/'));
  #   fn;
  # }); 
  ...
  setwd(path.temp); 
  capture.output(kegg<-pathview(kegg.dff, pathway.id=kegg.id, species = GetGenomeAlias(genome, "code"), low = list(gene = "blue"), kegg.dir=yml$input$gsea$kegg))->x; 
